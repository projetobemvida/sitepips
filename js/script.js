...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (localStorage.getItem("cookiesConsent") === "accepted") {
        loadGoogleAnalytics();
    } else if (localStorage.getItem("cookiesConsent") === "rejected") {
        // Não faz nada ou remove cookies existentes se necessário
    } else {
    ...
    rejectCookiesButton.addEventListener("click", function() {
        ...
        cookieConsentBanner.style.display = "none";
        // Lógica para remover cookies não essenciais, se houver
    });

    function loadGoogleAnalytics() {
        const script = document.createElement("script");
        script.async = true;
        script.src = "https://www.googletagmanager.com/gtag/js?id=G-6LQK24QYS2";
